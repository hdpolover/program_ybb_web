                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="text-center mb-5">
                            ...
                            <p class="text-muted mb-4">Meet the organizations who make our programs possible through their generous support and collaboration.</p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-header border-bottom-dashed">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="text-muted mb-0">Organizations working with us to achieve our mission</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body p-4">
                                            ...
                                            <div class="col">
                                                <div class="card card-animate border h-100">
                                                    <div class="card-body text-center">
                                                        <div class="mx-auto mb-4" style="height: 120px; display: flex; align-items: center; justify-content: center;">
                                                            <?php if (isset($partner['logo_url']) && !empty($partner['logo_url'])) : ?>
                                                                <img src="<?= function_exists('compress_image') ? compress_image($partner['logo_url'], 200, 120, 80, true) : $partner['logo_url'] ?>" alt="<?= $partner['name'] ?? 'Partner' ?> Logo" class="img-fluid" style="max-height: 120px;">
                                                            <?php else : ?>
                                                                <div class="avatar-lg">
                                                        ...
                                                        <p class="text-muted mb-3"><?= $partner['description'] ?? 'Partner Description' ?></p>
                                                        <?php if (isset($partner['website']) && !empty($partner['website'])) : ?>
                                                            <a href="<?= $partner['website'] ?>" target="_blank" class="btn btn-soft-primary btn-sm">
                                ...
                                <?php else : ?>
                                    <div class="text-center p-4">
                                        ...
                                        <p class="text-muted">Please check back later for information about our partners.</p>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
                            ...
                            <div class="card-header border-bottom-dashed">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="text-muted mb-0">Organizations providing financial support to our programs</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="d-flex flex-wrap gap-2 mb-4 sponsor-filter">
                                    <?php foreach ($sponsorLevels as $index => $level) : ?>
                                        <button class="btn <?= $index === 0 ? 'btn-primary' : 'btn-outline-primary' ?> sponsor-filter-btn" data-filter="<?= strtolower($level) ?>">
                                            <?php if ($level !== 'All') : ?>
                                                    ...
                                                    ?>
                                                        <div class="ribbon-box">
                                                            <div class="ribbon ribbon-shape <?= $badgeClass ?>">
                                                                <span class="text-white text-uppercase"><?= $sponsor['contribution_level'] ?></span>
                                                            </div>
                                                        </div>
                                                    <?php endif; ?>
                                                    
                                                    <div class="card-body text-center p-4">
                                                        <div class="mx-auto mb-4" style="height: 100px; display: flex; align-items: center; justify-content: center;">
                                                            <?php if (isset($sponsor['logo_url']) && !empty($sponsor['logo_url'])) : ?>
                                                                <img src="<?= function_exists('compress_image') ? compress_image($sponsor['logo_url'], 180, 100, 80, true) : $sponsor['logo_url'] ?>" alt="<?= $sponsor['name'] ?? 'Sponsor' ?> Logo" class="img-fluid" style="max-height: 100px;">
                                                            <?php else : ?>
                                                                <div class="avatar-lg">
                                                                    <div class="avatar-title bg-light text-primary fs-24 rounded">
                                                        ...
                                                        <p class="text-muted mb-3"><?= $sponsor['description'] ?? 'Sponsor Description' ?></p>
                                                        <?php if (isset($sponsor['website']) && !empty($sponsor['website'])) : ?>
                                                            <a href="<?= $sponsor['website'] ?>" target="_blank" class="btn btn-soft-primary btn-sm">
                                                                <i class="ri-links-line me-1 align-middle"></i> Visit Website
                                                            </a>
                                                        <?php endif; ?>
                                                    </div>
                                ...
                                <?php else : ?>
                                    <div class="text-center p-4">
                                        ...
                                        <p class="text-muted">Please check back later for information about our sponsors.</p>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
                            ...
                            <div class="card-body p-4 position-relative">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-8">
                                        ...
                                        <p class="text-white-75 mb-lg-0">We are always looking for organizations and individuals who share our mission and want to make a positive impact. Learn how you can become a partner or sponsor.</p>
                                    </div>
                                    <div class="col-lg-4 text-lg-end">
                                        <a href="javascript:void(0);" class="btn btn-light shadow-lg">Contact Us <i class="ri-arrow-right-line align-bottom ms-1"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
