...
<section class="section py-5 position-relative" id="contact">
    <div class="bg-overlay bg-overlay-pattern opacity-25"></div>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="text-center mb-5">
                    <h1 class="mb-3 ff-secondary fw-semibold text-capitalize lh-base">Get in Touch</h1>
                    <p class="text-muted fs-16">We'd love to hear from you. Contact us for any questions or inquiries about our programs.</p>
                </div>
            </div>
        </div>
