<div class="tab-pane fade" id="steparrow-preview" role="tabpanel" aria-labelledby="steparrow-preview-tab">
    <div class="preview-container">
        ...
        <!-- Action Section -->
        <div class="text-center mb-4">
            <?php if (isset($hasSuccessfulPayment) && $hasSuccessfulPayment === true): ?>
                <?php if (isset($hasSubmittedForm) && $hasSubmittedForm === true): ?>
                    <div class="alert alert-success">
                        <i class="ri-check-double-line me-2"></i> Your application has already been submitted.
                    </div>
                <?php else: ?>
