...
<body>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <p>
                                                                ...
                                                                <?php else: ?>
                                                                <span class="badge bg-secondary">Reference
                                                                    Document</span>
                                                                <?php endif; ?>
                                                            </p>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            <h6 class="text-muted fw-semibold mb-1">Available Since:
                                                            </h6>
                                                            <p><?= date('F d, Y', strtotime($document['created_at'])) ?>
                                                            </p>
                                                        </div>
                                                        <?php endif; ?>
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <p><span class="badge bg-danger">Required Document</span>
                                                            </p>
                                                        </div>
                                                        <?php endif; ?>
                                                    </div>
                                            ...
                                            <div class="card border shadow-none mb-3">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="mb-3 text-center">
                                                        ...
                                                        <a href="<?= $document['drive_url'] ?>"
                                                            class="btn btn-info w-100" target="_blank">
                                                            <i class="ri-external-link-line align-middle me-1"></i> Open
                                                            Document
                                                        </a>
                                                    </div>
                                                    <?php elseif (isset($document['is_upload']) && $document['is_upload']): ?>
                                                    <div class="mb-3 text-center">
                                                        <div class="mb-3">
                                                            <i
                                                                class="ri-upload-cloud-2-line text-warning display-5"></i>
                                                        </div>
                                                        <h6 class="fs-15 mb-3">Upload Required</h6>
                                                        <p class="text-muted mb-2">You need to upload this document as
                                                            part of your program requirements.</p>
                                                        <a href="#" class="btn btn-warning w-100">
                                                            <i class="ri-upload-2-line align-middle me-1"></i> Upload
                                                            Document
                                                        </a>
                                                    </div>
                                                    ...
                                                    <div class="mb-3 text-center">
                                                        ...
                                                        <p class="text-muted mb-2">Click below to generate your
                                                            personalized document. This document is important for your
                                                        ...
                                                        <button id="generate-loa-btn" class="btn btn-success w-100"
                                                            ...
                                                            <i class="ri-file-paper-2-line align-middle me-1"></i>
                                                            Generate Document
                                                        </button>
                                                    </div>
                                                    <?php else: ?>
                                                    <div class="text-center p-3">
                                                        ...
                                                        <p class="text-muted">No document file is available at this
                                                            time. Please check back later.</p>
                                                    </div>
                                                    <?php endif; ?>
                                                    ...
                                                    <div class="alert alert-warning mb-0 mt-3">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="flex-grow-1">
                                                                ...
                                                                <small>This document is required for your program
                                                                    participation.</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <ul class="list-group list-group-flush">
                                                        ...
                                                        <li class="list-group-item px-0">
                                                            <div class="d-flex align-items-start">
                                                                ...
                                                                <div class="flex-grow-1">
                                                                    <a href="<?= base_url('documents/program/details/' . $relatedDoc['id']) ?>"
                                                                        class="text-reset">
                                                                        <?= $relatedDoc['name'] ?>
                                                                    </a>
                                                                </div>
    ...
    $(document).ready(function() {
        $('.dropify').dropify({
            messages: {
                'default': 'Drag and drop a PDF file here or click',
