                            ...
                            <div class="row justify-content-center g-0">
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4 auth-one-bg h-100"
                                        style="background-image: url('<?= $webSettings['img_url'] ?? '/assets/images/bg-auth.jpg' ?>');">
                                        <div class="bg-overlay"></div>
                                        <div
                                            class="position-relative h-100 d-flex flex-column justify-content-center align-items-center">
                                            <div class="mb-4 text-center">
                                                <a href="/" class="d-block">
                                                    <img src="<?= $webSettings['logo_url'] ?? '/assets/images/logo-light.png' ?>"
                                                        alt="Logo" height="80" class="mx-auto">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div>
                                            <h5 class="text-primary">Participate in
                                                <?= $program['name'] ?? 'Our Programs' ?></h5>
                                            ...
                                            <div class="alert alert-info alert-dismissible fade show" role="alert">
                                                ...
                                                <span class="text-success">Fully Funded</span> - Reimbursement program
                                                with essays and interviews
                                                <?php else: ?>
                                                <span class="text-primary">Self Funded</span> - Guaranteed participation
                                        ...
                                        <div class="mt-4">
                                            <form action="<?= base_url('register') ?>" method="post"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="position-relative auth-pass-inputgroup">
                                                        <input type="password" class="form-control pe-5 password-input"
                                                            name="confirm_password" onpaste="return false"
