...
class ChatWidget {
    ...
    init() {
        ...
        try {
            ...
            console.log('📋 Step 4: Initializing session...');
            this.initializeSession();
            console.log('✅ Session initialized:', this.sessionId);
            
            console.log('📋 Step 5: Loading chat history...');
            ...
            console.log('✅ Service status check initiated');
     ...
     */
    loadConfig() {
        console.log('🔍 Looking for chat widget element...');
        const widgetElement = document.getElementById('chat-widget');
        console.log('🎯 Widget element found:', widgetElement);
        
        if (!widgetElement) {
            console.error('❌ Chat widget element with id="chat-widget" not found in DOM');
        ...
        console.log('🎯 Config data raw:', configData);
        
        if (!configData) {
            console.error('❌ Chat widget configuration data-config attribute not found');
            console.log('🔍 Available attributes:', Array.from(widgetElement.attributes).map(attr => attr.name));
            throw new Error('Chat widget configuration not found');
        }

        console.log('📋 Parsing configuration...');
        this.config = JSON.parse(configData);
        console.log('✅ Configuration parsed successfully:', this.config);
        ...
        console.log('✅ API service initialized with endpoint:', this.config.api_endpoint);
    }
